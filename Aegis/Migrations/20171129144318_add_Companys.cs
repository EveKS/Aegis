...
{
    public partial class add_Companys : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FadInn = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    FadType = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ...
                    Syte = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                name: "AdditionaServices",
                columns: table => new
                {
                    AdditionaServicesId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    CompanyId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    Type = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_AdditionaServices", x => x.AdditionaServicesId);
                    table.ForeignKey(
                        name: "FK_AdditionaServices_Companys_CompanyId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    DeliveryRegionId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    CompanyId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    Region = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_DeliveryRegions", x => x.DeliveryRegionId);
                    table.ForeignKey(
                        name: "FK_DeliveryRegions_Companys_CompanyId",
                        column: x => x.CompanyId,
                        principalTable: "Companys",
                        principalColumn: "CompanyId",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Deliverys_Companys_CompanyId",
                        column: x => x.CompanyId,
                        principalTable: "Companys",
                        principalColumn: "CompanyId",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AdditionaServices_CompanyId",
                table: "AdditionaServices",
                column: "CompanyId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DeliveryRegions_CompanyId",
                table: "DeliveryRegions",
                column: "CompanyId");

            migrationBuilder.CreateIndex(
                name: "IX_Deliverys_CompanyId",
                table: "Deliverys",
                column: "CompanyId");
